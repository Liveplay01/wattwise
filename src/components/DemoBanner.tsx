...
export default function DemoBanner() {
  ...
  return (
    <div className="absolute top-16 left-1/2 -translate-x-1/2 z-[1000] w-[calc(100%-2rem)] max-w-lg pointer-events-auto mt-2">
      <div className="flex items-start gap-3 rounded-xl border border-yellow-400/30 bg-yellow-400/10 backdrop-blur-md px-4 py-3 shadow-lg">
        ...
        <p className="text-xs text-yellow-200/90 flex-1 leading-relaxed">
          ...
          {" · "}
          Alle Empfehlungen basieren auf öffentlichen Wetterdaten und dienen
          nur zu Informationszwecken. Kein Ersatz für eine professionelle
          Energieberatung. Nur für Deutschland verfügbar.
        </p>
        <button

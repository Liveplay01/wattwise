  ...
  useEffect(() => {
    ...
    function updateColors(dt: number) {
      ...
      if (colorUpdateTimer >= 1) {
        ...
        pointers.forEach((p) => { p.color = generateColor() as unknown as number[]; });
      }
    }
    ...
    function splatPointer(pointer: Pointer) {
      ...
      splat(pointer.texcoordX, pointer.texcoordY, dx, dy, pointer.color as unknown as { r: number; g: number; b: number });
    }
    ...
    function updatePointerDownData(pointer: Pointer, id: number, posX: number, posY: number) {
      ...
      pointer.deltaX = 0;
      pointer.deltaY = 0;
      pointer.color = generateColor() as unknown as number[];
    }
    ...
    function updatePointerMoveData(pointer: Pointer, posX: number, posY: number, color: { r: number; g: number; b: number }) {
      ...
      pointer.color = color as unknown as number[];
    }
    ...
    function handleMouseMove(e: MouseEvent) {
      ...
      if (!firstMouseMoveHandled) {
        ...
        updatePointerMoveData(pointer, posX, posY, pointer.color as unknown as { r: number; g: number; b: number });
      }
    }
    ...
    function handleTouchMove(e: TouchEvent) {
      ...
      const pointer = pointers[0];
      for (let i = 0; i < touches.length; i++) {
        updatePointerMoveData(pointer, scaleByPixelRatio(touches[i].clientX), scaleByPixelRatio(touches[i].clientY), pointer.color as unknown as { r: number; g: number; b: number });
      }
    }
